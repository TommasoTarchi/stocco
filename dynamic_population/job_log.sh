...
echo "#" >> "$datafile"
echo "# N_tilde: growing logistically starting from 10000" >> "$datafile"
...
for index in {1..20}
do
    python3 ../src/dynamic_population.py --m 4 --N_0 10000 --N_tilde_mod "growing" --fitness "increasing_inc" --output "population" --datafile "$datafile"
done 
